        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white shadow-lg shadow-slate-600 rounded-lg p-8">
                ...
                <div className='justify-between'>
                    <Button onClick={() => deleteData()} className="mt-6 px-4 py-2 mx-4 bg-white text-red-950 border-2 border-red-950 rounded hover:bg-red-950 hover:text-white hover:border-0">Deletar</Button>
