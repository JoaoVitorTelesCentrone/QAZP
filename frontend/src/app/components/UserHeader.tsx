  ...
  return (
    <div className=" flex h-full p-8 bg-primary justify-between ">
      <div className="flex justify-between">
        <h1 className="text-secondary mr-10">
          <TreePalm />
        </h1>
      ...
      <ul className="flex justify-around mx-auto">
        <Link
          href="/dashboard"
          className="mx-6 text-secondary font-montserrat font-medium hover:transition delay-100 hover:scale-125"
        >
          Dashboard
        </Link>
        <Link
      ...
      <button
        className="text-white px-4 py-1 rounded-xl mx-4 hover:transition delay-100 hover:scale-125"
