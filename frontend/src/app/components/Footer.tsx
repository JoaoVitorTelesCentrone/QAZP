    ...
    <div className="bg-quartenary p-10">
      <ul className="flex justify-around">
        ...
        <a href="https://github.com/Uendell">
          <li className="text-secondary text-sm">Uendell Rios</li>
        </a>
        <a href="https://github.com/JoaoVitorTelesCentrone">
          <li className="text-secondary text-sm">João Centrone</li>
        </a>
        <a href="https://github.com/GustavoAlvesValadao">
          <li className="text-secondary text-sm">Gustavo Alves</li>
        </a>
      </ul>
    </div>
  )
