...
const Call = () => {
  return (
    <div className='flex flex-col py-40 px-12'>
        ...
        <button className='bg-custom-secondary mx-auto p-4 shadow-lg shadow-custom-secondary max-w-[230px] rounded-2xl text-custom-primary'>Solicite um orçamento</button>
    </div>
  )
}
