...
const Page = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex m-10">
        <div className="mx-14">
          ...
          <p className="mt-2 font-medium text-2xl font-montserrat text-secondary text-center">
            ...
            outros campos como por exemplo para os testes automatizados e2e com
            o cypress ou qualquer outra ferramenta.
          </p>
        </div>
        <div className="mx-14 mt-32">
          ...
          <p className="mt-2 font-medium text-2xl font-montserrat text-secondary text-center">
            ...
            software que possuisse um backend e um frontend. Para o backend foi
            escolhido C# visando sua largua utilização. Para o front foi
            utilizado next js junto com typescript, para a estilização tailwind
            e a lib de componentes shadcn.ui.
          </p>
        </div>
      </div>
      <div className="flex m-10">
        <div className="mx-14">
          ...
          <p className="mt-2 font-medium text-2xl font-montserrat text-secondary text-center">
            Ao construir esse projeto tivemos em vista alguns objetivos como por
            exemplo, a utilização do mesmo como projeto piloto para a escrita e
            implementação de uma cobertura de testes automatizados. Ou para a
            iniciação de devs junior onde nele é possível implementar e criar
            novas funcionalidades assim como testar e entender regras de
            negócio.
          </p>
        </div>
      ...
      <h1 className="mt-24 font-bold text-5xl mx-auto font-montserrat uppercase text-center text-tertiary">
        Nossa equipe
      </h1>
