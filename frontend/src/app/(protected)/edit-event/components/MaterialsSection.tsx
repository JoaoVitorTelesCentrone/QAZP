...
import { MaterialCategory } from '@/app/(protected)/create-event/constants/materialCategory'
import { MaterialType } from '@/app/(protected)/create-event/types/createEventTypes'
...
export default function MaterialsSection({
  ...
  const materialColumns = [
    ...
    },
    {
      title: '',
      key: 'action',
      render: (_value: unknown, _record: EditEventMaterial, index: number) => (
        <LucideTrash2
