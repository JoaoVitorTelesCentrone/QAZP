  ...
  return (
    <div>
      ...
      <div className="p-20 bg-primary">
        <h1 className="text-6xl mx-auto font-montserrat font-bold uppercase text-center text-secondary ">
        ...
        <div className="my-10 text-center justify-center flex">
          <button
            ...
            className="bg-white border-[0.5px] border-white text-primary p-4 rounded-xl font-bold uppercase mx-10 hover:bg-blue-950 hover:shadow-slate-500 shadow-lg hover:transition duration-400 hover:scale-125"
          >
            Enviar solicitação
          </button>
        </div>
